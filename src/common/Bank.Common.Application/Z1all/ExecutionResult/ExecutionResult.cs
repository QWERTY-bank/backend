using Bank.Common.Application.Z1all.ExecutionResult.Base;
using Bank.Common.Application.Z1all.ExecutionResult.Errors;
using System.Collections.Immutable;

namespace Bank.Common.Application.Z1all.ExecutionResult
{
