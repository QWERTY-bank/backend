using Bank.Common.Application.Z1all.ExecutionResult.StatusCode.Base;
using Bank.Common.Application.Z1all.ExecutionResult.StatusCode.Errors;
...
namespace Bank.Common.Application.Z1all.ExecutionResult.StatusCode
{
    ...
    public class ExecutionResult<TSuccessResult> : BaseExecutionResult<TSuccessResult, StatusCodeExecutionResult>
    {
        ...
        public static ExecutionResult<TSuccessResult> FromError<TResult>(ExecutionResult<TResult> errorResult) => new ExecutionResult<TSuccessResult>(errorResult.StatusCode, errorResult.Errors);
