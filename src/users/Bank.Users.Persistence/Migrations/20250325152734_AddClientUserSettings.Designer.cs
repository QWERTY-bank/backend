...
namespace Bank.Users.Persistence.Migrations
{
    ...
    [Migration("20250325152734_AddClientUserSettings")]
    partial class AddClientUserSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bank.Users.Domain.Settings.ClientUserSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("HiddenAccounts")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("IsNightTheme")
                    ...
                    b.ToTable("ClientUserSettings", "bank_users");
                });
            ...
            modelBuilder.Entity("Bank.Users.Domain.Settings.ClientUserSettings", b =>
                {
                    b.HasOne("Bank.Users.Domain.Users.UserEntity", "User")
                        .WithOne()
                        .HasForeignKey("Bank.Users.Domain.Settings.ClientUserSettings", "UserId")
