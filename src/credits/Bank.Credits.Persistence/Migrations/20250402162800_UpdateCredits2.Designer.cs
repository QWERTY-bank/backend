...
namespace Bank.Credits.Persistence.Migrations
{
    ...
    [Migration("20250402162800_UpdateCredits2")]
    partial class UpdateCredits2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bank.Credits.Domain.User.UserEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("RatingIsActual")
                        .HasColumnType("boolean");

                    b.HasKey("Id");

                    b.ToTable("Users", "bank_credits");
                });
            ...
            modelBuilder.Entity("Bank.Credits.Domain.Credits.Credit", b =>
                {
                    ...
                    b.HasOne("Bank.Credits.Domain.User.UserEntity", "User")
                        .WithMany("Credits")
                    ...
                    b.OwnsOne("Bank.Credits.Domain.Credits.CreditPaymentsInfo", "PaymentsInfo", b1 =>
                        {
                            ...
                            b1.Property<decimal>("DebtAmount")
                                .HasColumnType("numeric");

                            b1.Property<string>("DebtsWithInterest")
                                .IsRequired()
                                .HasColumnType("text");

                            b1.Property<decimal>("EqualPayment")
                                .HasColumnType("numeric");

                            b1.Property<DateOnly?>("LastInterestChargeDate")
                                .HasColumnType("date");

                            b1.Property<DateOnly?>("NextPaymentDate")
                                .HasColumnType("date");

                            b1.Property<int>("PeriodDays")
                                .HasColumnType("integer");

                            b1.Property<DateOnly?>("TakingDate")
                                .HasColumnType("date");
